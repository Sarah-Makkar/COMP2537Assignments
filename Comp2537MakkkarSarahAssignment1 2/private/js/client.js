    ...
    setInterval(function(e){
        $.ajax({
            ...
            success: function (data) {
                ...
                "<div id='articles'>";
                 for (let i = 0; i < array.length; i++) {
                     t2 += "<p id='title'>" + array[i]['title'] + "</p><br><br><p id='body-text'>" +
                         array[i]['body'] + "</p><br><p id='date'>" + array[i]['date'] + " | News Item " + (i+1) + "</p><br><br><hr>";
                 }
                 t2 += "</div>";
                 let div = $("#newsfeed");
                 div.html(t2);
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                $("#newsfeed").text(jqXHR.statusText);
