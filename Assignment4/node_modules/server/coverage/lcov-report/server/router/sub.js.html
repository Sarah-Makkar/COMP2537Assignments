...
<a name='L14'></a><a href='#L14'>14</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">26x</span>
...
module.exports = (path, ...middle) =&gt; async ctx =&gt; {
  ...
  if ((typeof path === 'string' &amp;&amp; path === full) ||
    ...
    ctx.req.solved = true;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctx.res.headersSent) {
